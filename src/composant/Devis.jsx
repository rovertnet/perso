...
function Devis() {
  return (
    <>
      <div className="md:px-10 px-10  md:py-3 py-5 bg-cover object-cover bg-[url('../../public/house.jpg')] ">
        <div className="flex justify-between items-center">
          <button className=" bg-black md:py-2 py-2 md:px-14 px-7 text-white md:my-10 my-8 font-extrabold rounded-md">
            Modal
          </button>
          <div className=" flex justify-center items-center gap-3 bg-white/5 backdrop-blur-xl md:">
            <button className=" bg-black md:py-2 py-2 md:px-4 p-4 text-white md:my-10 my-8 font-extrabold rounded">
        ...
        <div className="flex flex-col md:flex-row-reverse justify-normal items-center gap-10">
          ...
          <div className=" md:w-4/5 w-5/3">
            <div className=" mb-10 shadow-lg bg-white/5 backdrop-blur-2xl rounded-md md:px-10 px-8 md:py-10 py-8 md:w-full w-full">
              {/* Formulaire */}
              <form action="">
